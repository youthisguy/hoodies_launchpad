...
export default function Home() {
  ...
  const topRow = {
    x: [
      18, 80, 145, 220, 285, 355, 410, 480, 545, 615, 672, 748, 805, 872, 935,
      1005, 1062, 1130,
    ],
  ...
  const midRow = {
    x: [
      40, 108, 175, 248, 318, 390, 450, 520, 592, 648, 718, 790, 858, 925, 992,
      1048, 1115, 1165,
    ],
  ...
  const bottomRow = {
    x: [
      25, 95, 158, 230, 300, 368, 438, 505, 572, 638, 705, 775, 840, 912, 978,
      1042, 1108, 1162,
    ],
    y: [
      140, 128, 145, 132, 148, 130, 145, 128, 142, 130, 148, 132, 145, 128, 142,
      130, 145, 132,
    ],
